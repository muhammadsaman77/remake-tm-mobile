...
import 'package:talabang_mandau/app/modules/videoCall/participant/remote_participant.dart';
import 'package:talabang_mandau/app/modules/videoCall/constants/json_constants.dart';
import 'package:talabang_mandau/app/modules/videoCall/utils/pair.dart';
...
class CustomWebSocket {
  ...
  String getWebSocketAddress() {
    final uri = Uri.parse(session.token); // Token Anda mengandung URL.
    return '${uri.scheme}://${uri.host}/openvidu'; // Tidak menyertakan port.
  }
  ...
  void onDisconnected() {
    print("onDisconnected:Disconnected");

...
class CreateKejadianView extends GetView<CreateKejadianController> {
  CreateKejadianView({super.key});
  CreateKejadianController controller = Get.put(CreateKejadianController());
  @override
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Obx(() => DropdownButtonFormField<JenisKejadian>(
                          value: controller.jenisKejadian == null
                              ? null
                              : controller.jenisKejadian,
                          decoration: InputDecoration(
                            prefixIcon: Icon(Icons.work),
                            labelText: 'Pilih Jenis Kejadian',
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12.0),
                            ),
                          ),
                          items: controller.listJenisKejadian
                              .map((e) => DropdownMenuItem<JenisKejadian>(
                                    value: e,
                                    child: SizedBox(
                                        width:
                              ...
                              .toList(),
                          onChanged: (value) {
                            controller.jenisKejadian = value;
                          },
                          validator: (value) {
                            if (value == null) {
                              return 'Jenis Kejadian wajib dipilih';
                            }
                            return null;
                          },
                        )),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText: 'Waktu Kejadian Terjadi',
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12.0),
                        ),
                      ),
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Waktu Kejadian Terjadi belum dipilih';
                        }
                        return null;
                      },
                    ),
